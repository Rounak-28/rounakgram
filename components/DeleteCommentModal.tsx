  ...
  return (
      <div className="w-screen h-screen fixed top-0 left-0 flex justify-center items-center backdrop-brightness-50 z-[50000]">
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className="w-full mx-8 border-2 dark:border-[1px] border-blue-300 dark:border-gray-200 rounded-xl bg-white   dark:bg-[#1e293b] text-xl flex flex-col overflow-hidden"
        >
          <button
